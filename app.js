...
let animationId = null;      // canvas rain
let lastQuery = "Jakarta";   // simpan kota terakhir
...
function toggleLang() {
  ...
  updateUILabels(); // update teks UI tanpa fetch
}

// Update UI labels for bilingual
function updateUILabels() {
  const btn = document.getElementById("langBtn");
  btn.textContent = currentLang === "id" ? "🌐" : "🌐"; // bisa ganti icon sesuai bahasa
  // Bisa tambahkan label lain nanti
}
...
// =====================
// Event listener after DOM ready
// =====================
document.addEventListener("DOMContentLoaded", () => {
  // tombol search & translate
  ...
  navigator.geolocation.getCurrentPosition(
    pos => {
      lastQuery = `${pos.coords.latitude},${pos.coords.longitude}`;
